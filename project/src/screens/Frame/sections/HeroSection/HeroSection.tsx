...
const processSteps = [
  {
    ...
    title: "Upload",
    description:
      "Submit an issue with a photo, video, description, or voice note.",
  },
  {
    icon: "/div-4.svg",
    title: "AI Sorts",
    description:
      "AI analyzes and forwards to the correct civic department automatically.",
  },
  {
    icon: "/div-2.svg",
    title: "Govt Responds",
    description:
      "Authorities update the status and resolve your complaint. Track every step!",
  },
];
  ...
  return (
    <section className="relative w-full bg-gradient-to-r from-blue-300 via-white to-green-100 min-h-screen">
      <div className="container mx-auto px-6 py-16">
          ...
          <div className="space-y-8">
            <div className="space-y-6">
              <h1 className="text-4xl lg:text-5xl xl:text-6xl font-bold leading-tight">
                <span className="text-blue-800 tracking-tight">
                  Report. Resolve.
                </span>
        ...
        <div className="mt-20 bg-gradient-to-r from-blue-200 via-white to-blue-100 rounded-t-3xl p-12">
          <div className="space-y-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {detailedSteps.map((step, index) => (
                  <div key={step.title} className="text-center space-y-6">
                    ...
                    <h3
                      className={`text-2xl font-semibold ${step.titleColor} [font-family:'Poppins',Helvetica]`}
                    >
                      {step.title}
                    </h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {statistics.map((stat) => (
                <Card
                  key={stat.label}
                  className="bg-blue-50 border-0 shadow-sm"
                >
